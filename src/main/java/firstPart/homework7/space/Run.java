...
import firstPart.homework7.space.shuttles.*;
...
public class Run {
    ...
    public static void main(String[] args) {
        ...
        IStart shuttle = new SpaceShuttle();
        spaceport.launchShuttle(shuttle);
        System.out.println();

        IStart spaceX = new SpaceX();
        spaceport.launchShuttle(spaceX);
        System.out.println();

        IStart myShuttle = new MyShuttle();
        spaceport.launchShuttle(myShuttle);
        System.out.println();
    }
}
